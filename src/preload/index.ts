...
const api = {
  ...
  updater: {
    ...
    apply: () => invoke('qihebox:updater:apply'),
  },
  ...
  windowLifecycle: {
    ...
    onWakeSearch: (cb: () => void): (() => void) => {
      ...
      ipcRenderer.on('qihebox:event:window:wake-search', listener)
      return () => ipcRenderer.removeListener('qihebox:event:window:wake-search', listener)
    },
  },
}
