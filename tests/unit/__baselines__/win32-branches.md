...
- src/main/core/updatePlan.ts:55 | win32-branch | tests/unit/updaterInstall.test.ts | if (input.platform === 'win32') return 'nsis'
...
- src/main/updaterMain.ts:53 | platform-read | tests/unit/updaterInstall.test.ts | platform: process.platform,
